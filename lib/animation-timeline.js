...
function timelineSelectedEvent_setPrototypeOf(o, p) { timelineSelectedEvent_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return timelineSelectedEvent_setPrototypeOf(o, p); }
...
function timelineSelectedEvent_getPrototypeOf(o) { timelineSelectedEvent_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return timelineSelectedEvent_getPrototypeOf(o); }
...
var Timeline = /*#__PURE__*/function (_TimelineEventsEmitte) {
  ...
  timeline_createClass(Timeline, [{
    ...
    value: function _renderTicks() {
      ...
      var smallStep = TimelineUtils.findGoodStep(valDistance / (screenWidth / this._options.stepSmallPx));
    ...
    value: function _renderRows() {
      ...
      if (data && data.rows) {
        ...
        data.rows.forEach(function (rowCalc) {
          ...
          _this7._ctx.fillStyle = TimelineStyleUtils.getRowFillColor(rowCalc.model, _this7._options);
            ...
            if (calcKeyframe.parentRow.groups) {
              calcKeyframe.parentRow.groups.forEach(function (group) {
                ...
                if (keyframesGroupOverlapped) {
                  ...
                  var snapped = _this10.snapVal(group.min);
